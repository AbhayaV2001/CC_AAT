...
/**
 * An Self test simulation will show how to 10 cloudlets will be distributed among
...
public class RoundRobin {
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets, int idShift){
		...
		int temp[] = {6558,2085,6093,1763,9639,3516,8990,9213,4357,2002};
	...
	public static void main(String[] args) {
		Log.printLine("Starting CloudSim Round Robin...\n");
		...
		try {
			...
			Log.printLine("CloudSim Round Robin Scheduling finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
